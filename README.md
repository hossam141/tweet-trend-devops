...
- **Terraform**: Used to provision the core infrastructure, including :
   -  Jenkins master, build node, and Ansible servers. 
   -  EKS cluster associated with the necessary roles and policies, ensuring a scalable and maintainable environment.
